...
public class DetallesPartido2 extends AppCompatActivity implements Constantes {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        //System.out.println("HA ENTRADO EN DETALLES2");
        ...
        System.out.println("propietario en Detalles2 "+propietario);
            ...
            public void onClick(View v) {
                if (!propietario) {
                    ...
                    if (mensaje.equals("OK")) {
                        ...
                        AdapterParticipantesPartido a = new AdapterParticipantesPartido(pedirLista(), R.layout.fila_participantes, DetallesPartido2.this, new AdapterParticipantesPartido.OnItemClickListener() {
                            @Override
